...
namespace LdCms.Web.Controllers.API.Basics.V2
{
    ...
    public class UploadController : BaseApiController
    {
        ...
        public UploadController(IBaseApiManager BaseApiManager, IHttpContextAccessor Accessor, IHostingEnvironment HostingEnvironment, IConfigService ConfigService, IAccountService AccountService, IMediaService MediaService) : base(BaseApiManager)
        {
