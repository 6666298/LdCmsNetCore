...
namespace LdCms.IBLL.Service
{
    ...
    public partial interface IMessageBoardService:IBaseService<Ld_Service_MessageBoard>
    {
        ...
        List<Ld_Service_MessageBoard> GetMessageBoardPaging(int systemId, string companyId, int pageId, int pageSize, out int rowCount);
        List<Ld_Service_MessageBoard> GetMessageBoardPaging(int systemId, string companyId, bool state, int pageId, int pageSize, out int rowCount);
